...
This file provides guidance to HEX Agent (HEX.com) when working with code in this repository.

```markdown
# HEX Template - React Modern Development Guide
...
After completing the user requirements, please update this HEX.md file to:
...
├── HEX.md             # Development guide and template documentation
